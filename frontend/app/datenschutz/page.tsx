    ...
    <div className="container mx-auto max-w-4xl px-8 py-12">
      <div className="prose prose-lg dark:prose-invert max-w-none prose">
        ...
        <p>
          ...
          datenschutzfreundlichen Webanalysedienst. Plausible verzichtet auf die
          Verwendung von Cookies und speichert keine personenbezogenen Daten wie
          IP-Adressen. Die Analyse erfolgt vollständig anonymisiert und dient
          ausschließlich der statistischen Auswertung der Nutzung unserer
          Website.
        </p>
        <p>
          Plausible Analytics wird von uns selbst gehostet. Alle Analysedaten
          verbleiben auf unseren eigenen Servern und werden nicht an Dritte
          übermittelt.
        </p>
        <p>
          Die Nutzung von Plausible Analytics erfolgt auf Grundlage von Art. 6
          Abs. 1 lit. f DSGVO. Unser berechtigtes Interesse liegt in der
          anonymen Analyse des Nutzerverhaltens, um unser Webangebot zu
          optimieren. Es werden keine personenbezogenen Daten an Dritte
          weitergegeben.
        </p>
        <p>
