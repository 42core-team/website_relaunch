...
export default async function EventQueueMatchesAdminPage({
    ...
    const interval: "minute" | "hour" | "day" =
        rawInterval === "minute" || rawInterval === "hour" || rawInterval === "day" ? (rawInterval as any) : "hour";
    ...
    const [matches, series] = await Promise.all([
        ...
        getQueueMatchesTimeSeries(id, interval, startDate.toISOString(), endDate.toISOString()),
    ])
