                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <SelectItem key="RUSH" value="RUSH">Rush Event</SelectItem>
                        </Select>
                    </div>
                    ...
                    <div>
                        ...
                        <Select 
                            ...
                            onChange={(value) => setTreeFormat(parseInt(value.toString(), 10))}
                            placeholder="Select tournament size"
                            disableAnimation
                        >
                            <SelectItem key="16" value="16">16 Teams</SelectItem>
                        </Select>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-xs text-default-500">
                            Repository templates allow you to provide a starter code for participants. 
                            Currently, this feature is only available for events hosted by the Core team.
                        </p>
                    </div>
