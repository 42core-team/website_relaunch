...
import { UserSearchResult, searchUsersForInvite, sendTeamInvite } from "@/app/actions/team";
...
export const TeamInviteModal = ({ isOpen, onClose, teamId, eventId }: TeamInviteModalProps) => {
    ...
    const handleInviteUser = async (userId: string) => {
        ...
        try {
            const success = await sendTeamInvite(teamId, userId);
                ...
                <ModalBody>
                    ...
                    <div className="max-h-[300px] overflow-y-auto">
                        {isSearching ? (
                            ...
                            <p className="text-default-500 text-center py-2">Type at least 2 characters to search</p>
                        ) : searchResults.length === 0 ? (
                            <p className="text-default-500 text-center py-2">No users found</p>
                        ) : (
                            searchResults.map((user) => (
                                <div key={user.id} className="flex justify-between items-center p-2 border-b border-default-200 last:border-0">
